...
<html>
  ...
  <div style="width= 80vw; text-align: right; margin-right: 10rem;">
   ...
   <center>
    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td>
              <a href="proses_konfirmasi.php?id=<?php echo $row['id']; ?>"  onclick="return confirm('Konfirmasi pesanan produk ini?')">Konfirmasi</a>
          </td>
      </tr>
    ...
    <p >Konfirmasi pesanan jika reseller telah membayar pesanan. </p>
