...
<html>
  ...
  <div style="width= 80vw; text-align: right; margin-right: 10rem;">
    ...
    <a href="pesanan.php" style="background-color: #745c97;">Pesanan</a>
   ...
   <center>
    ...
    <tbody>
      ...
      $query = "SELECT produk.nama_produk as nama_produk, 
                ...
                WHERE pesanan.resseler = ".$_SESSION['reseller']." AND pesanan.dikonfirmasi = '0';";
      ...
      ?>
       <tr>
          ...
          <td>
              <a href="proses_batal.php?id=<?php echo $row['id']; ?>"  onclick="return confirm('Batalkan pesanan produk ini?')">Batal</a>
          </td>
      </tr>
    ...
    <p >Lakukan pembayaran pada pesanan melalui Bank BRI No Rek : XXXXXXXX atas nama Virdha. Sertakanan kode pesanan anda. </p>
